(function($) {
	...
	$.fn.getVisible = function() {
		...
		return this.filter(function() {
			...
			//console.log('is_hidden', selector, is_hidden);
			var is_display_none = $elt.css('display') === 'none';
			//console.log('is_display_none', selector, is_display_none);
			var is_visibility_hidden = $elt.css('visibility') === 'hidden';
			//console.log('is_visibility_hidden', selector, is_visibility_hidden);
			var is_opacity_0 = parseInt($elt.css('opacity'), 10) === 0;
			//console.log('is_opacity_0', selector, is_opacity_0);
			if (is_hidden || is_display_none || is_visibility_hidden || is_opacity_0) {
				return false;
			}
			return true
		});
