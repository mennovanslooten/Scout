...
var actions = {
	...
	assertTitle: function(sub_title) {
		...
		return '<' + sub_title + '> is no substring of <' + title + '>';
	},
	...
	assertPage: function(sub_url) {
		...
		return '<' + sub_url + '> is no substring of <' + url + '>';
	},
	...
	assertResembles: function(selector, orig_filename) {
		var boundaries = this.getBoundaries(selector);
